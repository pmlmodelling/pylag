...
Note
----
gotm_data_reader is implemented in Cython. Only a small portion of the
...
cdef class GOTMDataReader(DataReader):
    ...
    in space, GOTM uses a dedicated Interpolator. The choice of 1D interpolator
    is made at run time.
    ...
    See also
    --------
    pylag.interpolation : Supported interpolators.
    """
