...
class ROMSReader_test(TestCase):
    ...
    def setUp(self):
        ...
        config.set('OCEAN_DATA', 'grid_type', 'rectilinear')
        config.set('OCEAN_DATA', 'time_dim_name', 'time')
        config.set('OCEAN_DATA', 'depth_dim_name_grid_rho', 's_rho')
        config.set('OCEAN_DATA', 'depth_dim_name_grid_w', 's_w')
        config.set('OCEAN_DATA', 'latitude_dim_name_grid_psi', 'latitude_grid_psi')
        config.set('OCEAN_DATA', 'longitude_dim_name_grid_psi', 'longitude_grid_psi')
        config.set('OCEAN_DATA', 'latitude_dim_name_grid_rho', 'latitude_grid_rho')
        config.set('OCEAN_DATA', 'longitude_dim_name_grid_rho', 'longitude_grid_rho')
        config.set('OCEAN_DATA', 'latitude_dim_name_grid_u', 'latitude_grid_u')
        config.set('OCEAN_DATA', 'longitude_dim_name_grid_u', 'longitude_grid_u')
        config.set('OCEAN_DATA', 'latitude_dim_name_grid_v', 'latitude_grid_v')
        config.set('OCEAN_DATA', 'longitude_dim_name_grid_v', 'longitude_grid_v')
        config.set('OCEAN_DATA', 'time_var_name', 'time')
        config.set('OCEAN_DATA', 'uo_var_name', 'uo')
        config.set('OCEAN_DATA', 'vo_var_name', 'vo')
        config.set('OCEAN_DATA', 'wo_var_name', 'wo')
        config.set('OCEAN_DATA', 'zos_var_name', 'zos')
        config.set('OCEAN_DATA', 'thetao_var_name', 'thetao')
        config.set('OCEAN_DATA', 'so_var_name', 'so')
        config.set('OCEAN_DATA', 'has_is_wet', 'False')
        config.set('OCEAN_DATA', 'Kz_method', 'File')
        config.set('OCEAN_DATA', 'Ah_method', 'File')
        config.set('OCEAN_DATA', 'Kz_var_name', 'Kz')
        config.set('OCEAN_DATA', 'Ah_var_name', 'ah')
