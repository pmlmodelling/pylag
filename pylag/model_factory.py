...
def get_model(config, datetime_start, datetime_end):
    ...
    if ocean_product_name == "ArakawaA":
        ocean_mediator = SerialMediator(config, datetime_start, datetime_end)
    ...
    if atmos_product_name == "ArakawaA":
        atmos_mediator = SerialMediator(config, datetime_start,
                                        datetime_end)
    ...
    if waves_product_name == "ArakawaA":
        waves_mediator = SerialMediator(config, datetime_start,
                                        datetime_end)
