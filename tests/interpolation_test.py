...
def test_get_barycentric_coords():
    xpos = 1.0
    ypos = 1.0
    x_tri = np.array([0.0, 2.0, 0.0], dtype=np.float32)
    y_tri = np.array([0.0, 0.0, 2.0], dtype=np.float32)
...
def test_shephard_interpolation():
    xpts = np.array([0.0, 1.0], dtype=np.float32)
    ypts = np.array([0.0, 1.0], dtype=np.float32)
    vals = np.array([1.0, 2.0], dtype=np.float32)
    val = interp.shephard_interpolation(0.5, 0.5, 2, xpts, ypts, vals)
